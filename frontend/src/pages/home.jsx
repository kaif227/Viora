    ...
    return ( 
        ...
        <div className="meetContainer">
            <div className="leftPanel">
                ...
                <div role="button" style={{display:"flex",gap:"10px"}} className="createNewMeeting">
                    <TextField onChange={e=>setMeetingCode(e.target.value)} id='outline' placeholder='Meeting Code'></TextField>
