...
import styles from "../styles/videoComp.module.css"; //module we use because if use module our css wont be override
...
export default function videoMeetComp() {
  ...
  let handleChat = () => {
    (setModal(!showModal), setNewMessages(0));
  };
  let sendMessage = () => {
            ...
            <div className={styles.chatRoom}>
              <div className={styles.chatContainer}>
                ...
                <div className={styles.chatHeader}>
                  ...
                  <IconButton onClick={handleChat} className={styles.closeChat}>
                    <CloseIcon />
                  </IconButton>
                </div>
